...
>(
  (
    ...
    const onResize = React.useCallback(() => {
      ...
      api.reInit({ active: isScrollable });
    }, [api]);
...
const CarouselDotNav = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => {
            ...
            >
              <div
                className={cn('w-3 h-3 rounded-full', {
                  'bg-of-primary-200': index === selectedIndex,
                  'bg-of-gray-500': index !== selectedIndex,
                })}
              />
            </DotButton>
          ))}
